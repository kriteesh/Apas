...
function Init(id)
{
    ...
    drawCanvas.addEventListener("touchend", onMouseUp, false);
 	...
 	drawCanvas.addEventListener("touchmove", function(e) {
            ...
            // Get the position of a touch relative to the drawCanvas
	      		function getTouchPos(drawCanvasDom, touchEvent) {
	                var rect = drawCanvasDom.getBoundingClientRect();
	                return {
...
function guessNumber(id)
{
  ...
  { 
	console.log("success");
	ctx_draw.fillStyle = "rgba(0, 255, 0, 0.25)";
	ctx_draw.fillRect(0, 0, drawCanvas.width, drawCanvas.height);

  }
  else 
  {
  	ctx_draw.fillStyle = "rgba(255, 0, 0, 0.25)";
	ctx_draw.fillRect(0, 0, drawCanvas.width, drawCanvas.height);
	// $("#reset").show();
